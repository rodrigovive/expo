...
@interface ABI41_0_0EXFaceEncoder()

@property (assign, nonatomic) BOOL swapWidthAndHeight;
@property CGAffineTransform transform;
@property ABI41_0_0EXFaceDetectionAngleTransformBlock angleTransformer;

@end

@implementation ABI41_0_0EXFaceEncoder
...
{
  ABI41_0_0EXFaceDetectionAngleTransformBlock transformer = ^(float angle) {return angle;};
  return [self initWithTransform:pointTransformer withRotationTransform:transformer];
}

- (instancetype)initWithRotationTransform:(ABI41_0_0EXFaceDetectionAngleTransformBlock)rotationTransform
{
